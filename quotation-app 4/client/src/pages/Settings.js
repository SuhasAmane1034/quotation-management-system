            ...
            <div className="card-body">
              ...
              <div className="form-group">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  {form.company_logo ? (
                    <img src={`http://localhost:3001${form.company_logo}`} alt="logo" style={{ width: 60, height: 60, objectFit: 'contain', borderRadius: 10, border: '1.5px solid var(--border)', background: 'white', padding: 3 }} />
                  ) : (
